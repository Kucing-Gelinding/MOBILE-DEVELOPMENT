...
class ButtonSaveCustomEdit @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : LinearLayout(context, attrs) {

    private val backgroundDrawable: Drawable =
        requireNotNull(ContextCompat.getDrawable(context, R.drawable.button_bg_secondary)) {
    ...
    private val textView: TextView = TextView(context).apply {
        text = "Save" // Change this to the appropriate text
