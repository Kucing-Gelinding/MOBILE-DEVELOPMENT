...
import com.bangkit.cunny.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun signIn() {
        ...
        lifecycleScope.launch {
            try {
                ...
                Log.d("SignIn", "Credential retrieved: ${result.credential}")
                handleSignIn(result)
    ...
    private fun playAnimation() {
        ...
        val registerNow =
            ObjectAnimator.ofFloat(binding.registerNow, View.ALPHA, 1f).setDuration(100)
